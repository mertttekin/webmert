<template>
    <div class="font-quicksand text-white text-center my-10 sm:my-20">
        ...
        <ul class="mt-16 space-y-10 sm:p-0 p-2">
            <li class="max-w-7xl mx-auto space-y-1 py-2 items-start text-start px-10 rounded-3xl bg-gradient-to-br from-[#693B93] via-[#6EBFF439] to-[#4690D400]">
                ...
                <p class="sm:text-xl text-lg">I work mostly on web applications ,than ı write scripts for online game platforms.<br>
