        ...
        <ul class="mt-16 space-y-10 sm:p-2 p-4">
            ...
            <li
                ...
                <p class="sm:text-xl text-lg">In my current role, I specialize in front-end development using Nuxt.js
                    ...
                    involved optimizing user experiences, ensuring seamless integration
                    with backend APIs, and maintaining high performance across various
            ...
            <li
                ...
                <p class="sm:text-xl text-lg"> started with the task of installing and commissioning our image
                    ...
                    I worked on RS485 Modbus RTU serial communication. I used Python Pyserial, Tkinter, and Pyqt5
                    library.
                    I developed a desktop application to detect disconnected cameras and notify the user instantly.
                    Also,
                    developed a web application to receive technical
                    requests, manage and store solutions. I use Python’s
                    Django library.</p>
            </li>
            <li
                class="max-w-7xl mx-auto space-y-1 py-2 items-start text-start px-10 rounded-3xl bg-gradient-to-br from-[#693B93] via-[#6EBFF439] to-[#4690D400]">
