    ...
    <div class="font-quicksand text-white text-center my-10 sm:my-20">
        ...
        <ul class="mt-16 space-y-10 sm:p-0 p-2">
            ...
            <li
                ...
                <p class="sm:text-xl text-lg"> started with the task of installing and commissioning our image processing
                    sotfware and solving the
                    problems with a remote connection.
                    I worked on RS485 Modbus RTU serial communication. I used Python Pyserial, Tkinter, and Pyqt5 library.
                    I developed a desktop application to detect disconnected cameras and notify the user instantly. Also,
