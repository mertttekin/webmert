<template>
        ...
        <div class="flex-1 w-1/2 relative overflow-y-visible">
            ...
            <svg class="absolute -top-32 left-0 animate-spin  lg:flex" xmlns="http://www.w3.org/2000/svg" width="333"
                ...
                <g filter="url(#filter0_f_41_196)">
                    ...
                    <ellipse cx="305.091" cy="224.891" rx="63.0934" ry="67.8907" fill="#EBFF00" />
                    <ellipse cx="220.134" cy="224.891" rx="63.0934" ry="67.8907" fill="#00C2FF" />
                </g>
                <defs>
                    <filter id="filter0_f_41_196" x="0.0405273" y="0" width="525.144" height="517"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="78.5" result="effect1_foregroundBlur_41_196" />
                    </filter>
                </defs>
            </svg>
    ...
    <div class="flex sm:space-x-20 space-x-5 max-w-7xl mx-auto items-center justify-center sm:justify-start mt-10">
        <button
