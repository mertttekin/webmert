<template>
    <div class=" max-w-7xl mx-auto sm:my-14 border-b sm:border-none mb-2">
        <ul
            ...
            <li class="hidden sm:block">Work Experience</li>
            <li class="hidden sm:block">Skills</li>
            <NuxtLink :to="'/project'">Projects</NuxtLink>
            <li class="hidden sm:block">About Me</li>
